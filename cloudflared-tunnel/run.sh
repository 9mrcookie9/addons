...
curl -sL -O https://github.com/cloudflare/cloudflared/releases/download/2022.10.3/cloudflared-linux-amd64 && mv cloudflared-linux-amd64 /usr/local/bin/cloudflared &&  chmod +x /usr/local/bin/cloudflared
